...
class LIParseErrorListener : public BaseErrorListener
{
...
// {
	...
	ANTLRInputStream input(ins);
		...
		LIParseErrorListener errorListener;
		...
		ret = visitor.visitPtg((LIParser::PtgContext *)tree).as<std::map<int, PointsToGraph>>();
