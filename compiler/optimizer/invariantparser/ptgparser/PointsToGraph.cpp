...
const Entry PointsToGraph::bottomEntry = { .caller = -1, .bci = -1, .clazz = 0, .type = Global, .clazzPtr = NULL };
const Entry PointsToGraph::nullEntry = { .caller = -1, .bci = -1, .clazz = 0, .type = Null, .clazzPtr = NULL };
